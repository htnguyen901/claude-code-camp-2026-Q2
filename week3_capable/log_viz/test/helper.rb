...
module SessionTestHelper
  ...
  def request_event(payload:, message_count: 1, tool_count: 0, iteration: 1, wrap_up: false, task: nil, last_user_text: nil)
    {
      phase: "request", iteration: iteration, wrap_up: wrap_up, task: task,
  ...
  def response_event(usage:, text: "ok", task: nil)
    { phase: "response", text: text, usage: usage, stop_reason: "end_turn", task: task,
      session_id: "test-session", at: Time.now.iso8601 }
  end
